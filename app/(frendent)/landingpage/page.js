        ...
        <>
            <div>
                ...
                <div className='w-full h-[500px] bg-red-50 flex ' >
                    ...
                    <div className='w-3/6 flex justify-center flex-col   '>
                        ...
                        <p className="text-gray-500 mt-4 text-center w-[60%]">
                            ...
                            Maecenas vitae enim pharetra, venenatis nunc eget, finibus est.
                            Maecenas , finibus est.
                        </p>
                        <Link href={"createrecipe/"}>
                            <button onClick={createRecipe} className=" w-[36%]  py-2 mt-4 ms-24 bg-[#b55] text-white rounded-md "  >
                ...
                <div className='bg-white w-full h-auto'>
                    <h3 className="text-3xl font-bold text-gray-800 p-5">
                        Trending Recipes
                    </h3>
                    <div className='flex overflow-scroll scrollbar-hide p-5 gap-10  '>
                        {recipes && recipes.slice(0, 12).map((value, index) =>
                            <div key={index} className=''>
                                <div className='w-[250px] h-[200px] bg-[#b55] rounded-md'>
                                    <Link href={`${value.title}`} ><img
                ...
                <div>
                    <div className='my-12'><Link href={"recipes"}>
                        <button className=" px-12 flex gap-5 py-2 mt-4 ms-24 bg-[#b55] text-white rounded-md " >
                            View All Recipes<ArrowRightIcon className='size-6' /></button></Link></div>
                    <Footer />
                </div>
            </div >
        </>
